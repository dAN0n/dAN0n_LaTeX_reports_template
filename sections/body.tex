...
Ещё пример (в двух вариантах форматирования кода, на мой взгляд, оба отстойные):
...
Пакет \emph{cleveref} изменяет стиль ссылок, вводя новые команды \verb|\сref{}| и \\ \verb|\Cref{}|.\cite{cleveref} Соль в том, что пакет определяет тип ссылки, и самостоятельно подписывает ее (например ,,\verb|рис. \ref{}|`` без необходимости писать ,,рис.`` самому). Встраивается в \emph{varioref}.
