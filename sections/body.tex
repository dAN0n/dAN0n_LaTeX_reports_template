...
\begin{figure}[H]
\centering
\captionsetup{justification=centering} % Вот эта строка, в принципе можно внести в шаблон, но я поленился, плюс ее выгоднее оставить как есть, чтобы помнить о ней 
...
Слишком потно, надо очень хорошо знать, что делаешь, иначе можно потратить день и не добиться результата. В документации \emph{1200} страниц, Карл!!!\cite{pgf}
...
Безумно неудобно, не делать так. Лучше, быстрее и выгоднее заюзать \emph{yEd} или что-нибудь в таком духе и вставить картинку. Есть способ делать удобнее с \emph{LuaTeX}, но \emph{LuaTeX} сам по себе ещё без релизной версии, ну его к чёрту. \\
