...
\begin{enumerate}
	...
	\textbf{UPD.} В процессе работы над шаблоном команды \string\vref\{\} и \string\Vref\{\} переопределены, и весь этот пункт стал неактуальным. Тип ссылки для листинга с \string\vref\{\} не подставляется.
\end{enumerate}
